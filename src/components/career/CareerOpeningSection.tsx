...
import { CAREER_OPENINGS_CONTENT, JOB_OPENINGS } from '@/constants/career/careeropening.constants'
  ...
  return (
    <motion.div
      className="
        ...
        px-5 py-5 sm:px-6 sm:py-6 2xl:px-8 2xl:py-7
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          ...
          className="
            ...
            rounded-full bg-[#8F3648] text-white
            flex items-center justify-center
            hover:bg-[#3D171F] transition-colors duration-150
          "
        >
      ...
      >
        ...
        <motion.div
          className="
            ...
            px-5 py-5 sm:px-7 sm:py-6 md:px-8 2xl:px-10 2xl:py-8
