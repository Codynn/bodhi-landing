...
const inputClass =
  'rounded-none border-0 border-b border-gray-300 bg-transparent px-0 shadow-none focus-visible:ring-0 focus-visible:border-[#8F3648] transition-colors placeholder:text-gray-400 text-[12px] sm:text-[14px] md:text-[15px] lg:text-[17px] xl:text-[18px] 2xl:text-[20px] h-8'
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* ══════════════════════════════════════════════
                TOP: two-column area (QR left, Form right)
                This flex row scrolls if content overflows
            ══════════════════════════════════════════════ */}
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <Button
                            ...
                            className="bg-[#8F3648] hover:bg-[#3D171F] text-white rounded-md px-3 py-1.5 h-auto text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] font-medium flex items-center gap-1.5"
                          >
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                ...
                                rows={2}
                                className="rounded-none border-0 border-b border-gray-300 bg-transparent shadow-none focus-visible:ring-0 focus-visible:border-[#8F3648] resize-none px-0 transition-colors placeholder:text-gray-400 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px]"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage className="text-[11px]" />
            ...
            {/* ══════════════════════════════════════════════
                BOTTOM: Submit button — spans FULL modal width
                Sits outside the two-column layout entirely
            ══════════════════════════════════════════════ */}
            <div className="flex-shrink-0 px-5 py-4 sm:px-6 sm:py-5 border-t border-gray-100 bg-white rounded-b-2xl">
              <Button
                ...
                className="
                  ...
                  rounded-full h-10 sm:h-11 2xl:h-12
