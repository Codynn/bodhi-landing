// constants/home/why-choose.constants.ts
...
export const PARENT_CHOOSE_CONTENT: WhyChooseContent = {
  ...
  description:
    'At Bodhi International Montessori School, we provide a safe, disciplined, and nurturing environment where every child can thrive academically, socially, and emotionally.',
  descriptionB:
    "We maintain regular communication with parents to keep them involved in their child's progress and provide guidance whenever needed.",
}
